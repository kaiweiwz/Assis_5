...
public class ChannelItemDao extends AbstractDao<ChannelItem, Long> {
    ...
    */
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("insert into CHANNEL_ITEM(name, order_id, selected) values('头条', 1,1)");
        db.execSQL("insert into CHANNEL_ITEM(name, order_id, selected) values('正能量', 2, 1)");
        db.execSQL("insert into CHANNEL_ITEM(name, order_id, selected) values('轻松一刻', 3, 1)");
        db.execSQL("insert into CHANNEL_ITEM(name, order_id, selected) values('奇闻趣事', 4, 1)");
    }
